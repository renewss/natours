...
const createSendToken = (user, statusCode, res) => {
    ...
    // Removing password property before sending
...
exports.isLoggedIn = async (req, res, next) => {
    if (req.cookies.jwt) {
        try {
            ...
            // USER IS LOGGED IN
            res.locals.user = currentUser; // this will be accessible in pug
            return next();
        } catch (err) {
            return next();
        }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    //WITHOUT this property mongo gives error "provide required fields(from Schema)"
